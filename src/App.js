...
export const App = () => (
  <Canvas camera={{ fov: 75, position: [0, 0, 20] }} eventSource={document.getElementById('root')} eventPrefix="client">
    ...
    <Frame id="01" name={`water\nmelon`} author="Omar Faruq Tawsif" bg="#e4cdac" position={[-1.15, 0, 0]} rotation={[0, 0.5, 0]}>
      <Gltf src="painterly_brushwork_study_with_pchans_painting.glb" scale={20} position={[-0.4, -0.7, -1]} />
    </Frame>
    <Frame id="02" name="tea" author="Omar Faruq Tawsif">
      <Gltf src="fiesta_tea-transformed.glb" position={[0, -2, -3]} />
    </Frame>
    <Frame id="03" name={`egg\nplant`} author="Omar Faruq Tawsif" bg="#d1d1ca" position={[1.15, 0, 0]} rotation={[0, -0.5, 0]}>
      <Gltf src="vitamin_bomb_the_brinjal_bomb.glb" scale={0.03} position={[0, -0.2, -1]} />
    </Frame>
    <Rig />
  </Canvas>
)
